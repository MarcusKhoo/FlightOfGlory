...
namespace GameStateManagementSample
{
    ...
    class MainMenuScreen : MenuScreen
    {
        ...
        {
            //set sound volume
            ScreenManager.Sound.SetCategoryVolume(OptionsMenuScreen.sfxVolume, OptionsMenuScreen.bgmVolume);

            ScreenManager.Sound.PlayBG_01();
            base.Activate(instancePreserved);
        }

        public override void Unload()
        {
            ScreenManager.Sound.StopBG_01();
            base.Unload();
        }
        ...
        {
            LoadingScreen.Load(ScreenManager, true,  e.PlayerIndex, new SelectionScreen());
        }
        ...
        {
            ScreenManager.AddScreen(new InstructionsMenuScreen(), e.PlayerIndex);
        }
